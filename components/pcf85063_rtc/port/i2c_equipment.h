...
/* Returns true if the PCF85063 responded during init (chip online),
 * false otherwise. Deviation from the Waveshare original (void) to
 * allow the caller to degrade gracefully instead of running blind. */
